  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Data Tabel/</span>Produk</h4>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('product.edit', $item->id) }}"><i class="ti ti-pencil me-2"></i>Edit</a>
                    ...
                    <nav aria-label="Page navigation" style="margin: 30px 30px 30px 20px;">
                        <ul class="pagination pagination-sm">
                            ...
                            @if ($product->lastPage() > 1)
                                ...
                                <!-- Page Numbers -->
                                @for ($i = max(1, $product->currentPage() - 2); $i <= min($product->lastPage(), $product->currentPage() + 2); $i++)
                            ...
                            @if ($product->hasMorePages())
                                <li class="page-item next">
                                    <a class="page-link" href="{{ $product->nextPageUrl() }}">
    ...
    <script>
        $(document).on('click', '.delete', function(e){
            ...
            Swal.fire({
            title: "Hapus Produk?",
            text: "Produk yang anda hapus tidak bisa dikembali",
            icon: "question",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
