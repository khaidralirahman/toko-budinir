...
<html
  ...
  <head>
    <title>Edit produk - super admin</title>
                    ...
                    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                            <div class="d-flex flex-column justify-content-center">
                                <h4 class="mb-1 mt-3">Edit Produk</h4>
                                <p class="text-muted">Ubah detail produk Anda</p>
                            </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($product->head_photo)
                                                <img src="{{ asset('assets/head_photo/'.$product->head_photo) }}" alt="Head Photo" class="img-thumbnail mt-2" style="max-width: 150px;">
                                            @endif
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            @if($product->head_photo_back)
                                                <img src="{{ asset('assets/head_photo_back/'.$product->head_photo_back) }}" alt="Head Photo Back" class="img-thumbnail mt-2" style="max-width: 150px;">
                                            @endif
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <form class="form-repeater">
                                            <div data-repeater-list="group-a">
                                                @if($mediaFiles = json_decode($product->media, true))
                                                    @foreach($mediaFiles as $mediaFile)
                                                    <div data-repeater-item>
                                                        <div class="row">
                                                            <div class="mb-3 col-lg-6 col-xl-10 col-12 mb-0">
                                                                <label class="form-label" for="form-repeater-1-1">Media Saat Ini</label>
                                                                <img src="{{ asset($mediaFile) }}" alt="Media" class="img-thumbnail mb-2" style="max-width: 150px;">
                                                                <input type="file" id="form-repeater-1-1" name="media[]" class="form-control" placeholder="input media" value="{{ $mediaFile }}"/>
                                                            </div>
                                        ...
                                        <div class="mb-3 col ecommerce-select2-dropdown">
                                            ...
                                            <select id="category-org" class="select2 form-select" name="categories_id" data-placeholder="Select Category">
                                                ...
                                                @foreach ($categories as $item)
                                                    <option value="{{ $item->id }}" @if($product->categories_id == $item->id) selected @endif>{{ $item->category }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!-- Status -->
                                        <div class="mb-3 col ecommerce-select2-dropdown">
                                            ...
                                            <select id="status-org" class="select2 form-select" name="labels_id" data-placeholder="Published">
                                                ...
                                                @foreach ($label as $item)
                                                    <option value="{{ $item->id }}" @if($product->label_id == $item->id) selected @endif>{{ $item->label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-3 col ecommerce-select2-dropdown">
                                            ...
                                            <select id="status-org" class="select2 form-select" name="is_active" data-placeholder="Published">
                                                <option value="1" @if($product->is_active) selected @endif>Publis Produk</option>
                                                <option value="0" @if(!$product->is_active) selected @endif>Draft</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
