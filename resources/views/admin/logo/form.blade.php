  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Formulir logo</h4>
                ...
                <div class="col-md">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form action="{{ route('logo.store') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Icon</label>
                                <input class="form-control" name="logo" type="file" id="formFile" value="{{ old('logo') }}" />
                            </div>
                          <div class="row">
                            <div class="col-12">
    ...
    <script>
        $(document).on('click', '.submit', function(e){
            ...
            Swal.fire({
            title: "Simpan logo?",
            text: "logo yang anda simpan bisa di edit kembali",
            icon: "question",
