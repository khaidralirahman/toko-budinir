...
<html
  ...
  <head>
    <title>Edit logo - super admin</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Edit logo</h4>
                        ...
                        <form action="{{ route('logo.update', $logo->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                <div class="col-lg-6 col-md-6 mb-3">
                                    ...
                                    @if($logo->logo)
                                        <img src="{{ asset('assets/logo/'.$logo->logo) }}" alt="Head Photo" class="img-thumbnail mt-2" style="max-width: 150px;">
                                    @endif
                                </div>
                            </div>
                            <div class="row">
