...
<html
  ...
  <head>
    <title>Update poster - super admin</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-md">
                    <div class="card">
                        <h5 class="card-header">Update Poster</h5>
                        <div class="card-body">
                            <form action="{{ route('poster.update', $poster->id) }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <input id="defaultInput" @error('subtitle') is-invalid @enderror name="subtitle"
                                            ...
                                            value="{{ old('subtitle', $poster->subtitle) }}" />
                                        @error('subtitle')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        @if($poster->media)
                                            <img src="{{ asset('assets/media/'.$poster->media) }}" alt="Head Photo" class="img-thumbnail mt-2" style="max-width: 150px;">
                                        @endif
                                    </div>
                                </div>
                                <div class="row">
