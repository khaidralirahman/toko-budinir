  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Data Table/</span>Label</h4>
                <!-- Basic Bootstrap Table -->
                <div class="card" style="margin-bottom: 50px">
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        <h5 class="card-header">Table Label</h5>
                        <a href="/admin/label/form" class="btn btn-primary" style="height: fit-content; padding: 15px 30px 15px 30px; margin-top: 20px; margin-right: 20px;">Add Label</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex; align-items: center;">
                                                <span
                                                    style="display: inline-block; width: 20px; height: 20px; background-color: {{ $item->color }}; border: 1px solid #ddd; margin-right: 10px;">
                                                </span>
                                                {{ $item->color }}
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <form action="{{ route('label.delete', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a class="dropdown-item" href="{{ route('label.edit', $item->id) }}"><i class="ti ti-pencil me-2"></i> Edit</a>
    ...
    <script>
        $(document).on('click', '.delete', function(e){
            ...
            Swal.fire({
            title: "Hapus Label?",
            text: "Label yang anda hapus tidak bisa dikembali",
            icon: "question",
