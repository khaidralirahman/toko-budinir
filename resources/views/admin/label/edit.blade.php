...
<html
  ...
  <head>
    <title>Edit label - super admin</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Edit label</h4>
                        ...
                        <form action="{{ route('label.update', $label->id) }}" method="POST">
                            ...
                            <div class="mb-3 row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <input id="defaultInput" name="label"
                                        class="form-control" type="text" placeholder="masukan label" autofocus
                                        value="{{ old('label', $label->label) }}" />
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <label for="defaultInput" class="form-label">Warna</label>
                                    <input id="defaultInput" name="color"
                                        class="form-control" type="color" placeholder="warna" id="html5-color-input"
